...
$$(document).on('page:init', function (e) {
    ...
    var pageColor = $$("div.page[data-page='" + pageName + "']").attr('data-pageColor');
    ...
    if (pageName === 'home') {
        ...
        $$("#bottom-left-triangle").css({ height: '20vh', width: '20vw', bottom: '-1px' });
        ...
        var target_fab = $$(".speed-dial-buttons a[data-page='" + pageName + "']");
    ...
    if (pageName == 'home') {
        ...
        tl.fromTo('#upper-right-triangle', .7, { top: "-=350" }, { top: -1 })
        .fromTo('#bottom-right-triangle, .action-box', .7, { bottom: "-=350"}, { bottom: -1 }, "-=.7")
        .fromTo('#bottom-left-triangle', .7, { bottom: "-=350"}, { bottom: -1 }, "-=.7");
    }
